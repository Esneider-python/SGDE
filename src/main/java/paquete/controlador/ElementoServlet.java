...
import paquete.dao.ReporteDao;
import paquete.dao.UsuarioDao;
import paquete.dao.ElementoEliminadoDao;
import paquete.dao.ElementoDao;
import paquete.dao.ElementoMobiliarioDao;
import paquete.dao.CambioIdentificadorDAO;
import paquete.dao.ElementoTecnologicoDao;
import paquete.dao.AulaDao;
import paquete.dao.HistorialMovimientoDao;
import paquete.modelo.ElementosMobiliarios;
import paquete.modelo.Elemento;
import paquete.modelo.CambioIdentificador;
import paquete.modelo.ElementoTecnologico;
...
public class ElementoServlet extends HttpServlet {
    ...
    private void moverElemento(HttpServletRequest request, HttpServletResponse response, Connection conexion)
        ...
        try {
            ...
            if (!aulaDao.existeAula(idAulaDestino)) {
